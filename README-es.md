...
JARVIS es una herramienta de automatización web con IA que se ejecuta en tu navegador. Es una alternativa gratuita a OpenAI Operator, con opciones flexibles de modelos de lenguaje (LLM) y un sistema multiagente.

⬇️ Obtén JARVIS gratis

🌟 ¿Te encanta JARVIS? ¡Danos una estrella 🌟 y ayúdanos a correr la voz!

❤️ Apoya el proyecto [patrocinándonos](https://github.com/sponsors/Aryan-crypt) - ¡cada contribución ayuda a mantener JARVIS gratuito y de código abierto!

<div align="center">
<img src="https://github.com/user-attachments/assets/112c4385-7b03-4b81-a352-4f348093351b" width="600" alt="JARVIS Demo GIF" />
<p><em>El sistema multiagente de JARVIS analizando HuggingFace en tiempo real, con el Planner autocorrigiéndose de forma inteligente al enfrentar obstáculos e instruyendo dinámicamente al Navigator para ajustar su enfoque, todo ejecutándose localmente en tu navegador.</em></p>
</div>

## 🔥 ¿Por qué usar JARVIS?

¿Buscas un potente agente de navegador con IA sin el precio de $200/mes de OpenAI Operator? **JARVIS**, como extensión de Chrome, ofrece capacidades avanzadas de automatización web mientras tú tienes el control total.
...
> **Nota:** Actualmente ofrecemos soporte para OpenAI, Anthropic, Gemini, Ollama, Groq, Cerebras, Llama y proveedores personalizados compatibles con OpenAI, próximamente se ofrecerá soporte a más proveedores.
...
1. **Instalar desde la página de versiones** (Versión estable):
   * Visita la página de [versiones de JARVIS en GitHub](https://github.com/Aryan-crypt/JARVIS-extension/releases)
   * Descarga el archivo `jarvis.zip` más reciente
   * Sigue las instrucciones de instalación en la sección ["Instalar Última Versión Manualmente"](#-instalar-última-versión-manualmente) abajo
...
2. **Configurar Modelos de Agente**:
   * Haz clic en el icono de JARVIS ubicado en la barra de herramientas para abrir el panel lateral
...
1. **Descargar**
    * Descarga el archivo `jarvis.zip` más reciente desde la [página de lanzamientos](https://github.com/Aryan-crypt/JARVIS-extension/releases) oficial en GitHub.

2. **Instalar**:
    * Extrae el archivo `jarvis.zip`.
    ...
    * Selecciona la carpeta descomprimida de `jarvis`.

3. **Configurar Modelos de Agente**
    * Haz clic en el icono de JARVIS en la barra de herramientas para abrir el panel lateral
    * Haz clic en el icono de `Settings` (arriba a la derecha).
    * Agrega tus claves de API del LLM
    * Elige qué modelo usar para cada agente (Navigator, Planner)

4. **Actualizar**:
    * Descarga el archivo `jarvis.zip` más reciente desde la página de lanzamientos.
    * Extrae y reemplaza los archivos existentes de JARVIS con los nuevos.
    * Ve a `chrome://extensions/` en Chrome y haz clic en el icono de actualizar en la tarjeta de JARVIS.

## 🛠️ Compilar desde el Código Fuente

Si prefieres compilar JARVIS por ti mismo, sigue estos pasos:
...
JARVIS te permite configurar distintos modelos LLM para cada agente para equilibrar costo y rendimiento. Aquí están las configuraciones recomendadas:
...
Estamos desarrollando activamente JARVIS con características emocionantes en el horizonte. ¡Te invitamos a unirte!

Consulta nuestra hoja de ruta detallada y las características próximas en nuestras [Discusiones de GitHub](https://github.com/Aryan-crypt/JARVIS-extension/discussions). 

## 🤝 Contribuciones

**Necesitamos tu ayuda para hacer que JARVIS sea aún mejor!**  Se aceptan contribuciones de todo tipo:

*  **Comparte Prompts y Casos de Uso** 
   * Únete a nuestro [servidor de Discord](https://discord.gg/NN3ABHggMK).
   * Comparte cómo estás usando JARVIS. Ayúdanos a construir una biblioteca de prompts útiles y casos de uso reales.
*  **Proporciona Retroalimentación** 
   * Prueba JARVIS y danos tu opinión sobre su rendimiento o sugiere mejoras en nuestro [servidor de Discord](https://discord.gg/NN3ABHggMK).
...
En su lugar, por favor crea un [GitHub Security Advisory](https://github.com/Aryan-crypt/JARVIS-extension/security/advisories/new) para reportar la vulnerabilidad de forma responsable. Esto nos permite abordar el problema antes de que se divulgue públicamente.

¡Agradecemos tu ayuda para mantener JARVIS y sus usuarios seguros!
...
- [Twitter](https://x.com/aryan_sahani_) - Síguenos para actualizaciones y anuncios
- [GitHub Discussions](https://github.com/Aryan-crypt/JARVIS-extension/discussions) - Comparte ideas y realiza preguntas

## 👏 Agradecimientos

JARVIS se construye sobre otros increíbles proyectos de código abierto:
...
Hecho con ❤️ por Aryan Sahani.

¿Te gusta JARVIS? ¡Danos una estrella 🌟 y únete a nosotros en [Discord](https://discord.gg/NN3ABHggMK) | [X](https://x.com/aryan_sahani_)
